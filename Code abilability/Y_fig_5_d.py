...
for rat_name in rats:
    ...
    (Corr) = joblib.load(data_dir + rat_name + '_Y_vCA1ex_PL5ex_coactivity_all_nrem_crip.joblib')
    C=np.append(C,Corr)
...
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_5_d_vCA1ex_PL5ex.joblib'), compress=3)
...
for rat_name in rats:
    data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data3\\'
    #(Corr, _) = joblib.load(data_dir + rat_name + '_vCA1ex_BLAex_N_N_SWR_corr.joblib')
    (Corr) = joblib.load(data_dir + rat_name + '_Y_vCA1ex_BLAex_coactivity_all_nrem_crip.joblib')
    C=np.append(C,Corr)
...
#NN NR
ax2.annotate('', xy=(0.05,L_mean*1.08), xytext=(1.9,L_mean*1.08), arrowprops=props)
ax2.text(0.9,L_mean*1.08 , "*",fontsize=15)
#NN RN
...
data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data5\\'
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_5_d_vCA1ex_BLAex.joblib'), compress=3)
...
for rat_name in rats:
    data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data3\\'
    #(Corr, _) = joblib.load(data_dir + rat_name + '_vCA1ex_BLAex_N_N_SWR_corr.joblib')
    (Corr) = joblib.load(data_dir + rat_name + '_Y_PL5ex_BLAex_coactivity_all_nrem_crip.joblib')
    C=np.append(C,Corr)
...
data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data5\\'
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_5_d_PL5ex_BLAex.joblib'), compress=3)
