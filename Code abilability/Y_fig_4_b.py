...
for rat_name in rats:
    ...
    (Corr) = joblib.load(data_dir + rat_name + '_Y_vCA1ex_coactivity_all_nrem_spindle.joblib')
...
ax1.annotate('', xy=(0.2,L_mean*1.01), xytext=(0.8,L_mean*1.01), arrowprops=props)
ax1.text(0.4,L_mean*1.01 , "*",fontsize=15)
ax1.annotate('', xy=(1.2,L_mean*1.01), xytext=(1.8,L_mean*1.01), arrowprops=props)
...
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_3_f_vCA1ex_2.joblib'), compress=3)
...
for rat_name in rats:
    data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data3\\'
    (Corr) = joblib.load(data_dir + rat_name + '_Y_PL5ex_coactivity_all_nrem_spindle.joblib')
...
#ax1.annotate('', xy=(0.2,L_mean*1.02), xytext=(0.8,L_mean*1.02), arrowprops=props)
#ax1.text(0.45,L_mean*1.02 , "**",fontsize=15)
ax2.annotate('', xy=(0.2,L_mean*1.01), xytext=(0.8,L_mean*1.01), arrowprops=props)
ax2.text(0.4,L_mean*1.01 , "*",fontsize=15)
ax2.annotate('', xy=(0.2,L_mean*1.06), xytext=(1.8,L_mean*1.06), arrowprops=props)
ax2.text(0.9,L_mean*1.06 , "***",fontsize=15)
ax2.annotate('', xy=(1.2,L_mean*1.01), xytext=(1.8,L_mean*1.01), arrowprops=props)
...
data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data5\\'
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_3_f_PL5ex_2.joblib'), compress=3)
...
for rat_name in rats:
    data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data3\\'
    (Corr) = joblib.load(data_dir + rat_name + '_Y_BLAex_coactivity_all_nrem_spindle.joblib')
...
data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data5\\'
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_3_f_BLAex_2.joblib'), compress=3)
...
fig.suptitle('co-activity Zscore in spindle during nrem', fontsize=20)
