...
for rat_name in rats:
    ...
    (Corr) = joblib.load(data_dir + rat_name + '_Y_vCA1ex_coactivity_all_nrem_hfo.joblib')
...
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_3_g_vCA1ex_2.joblib'), compress=3)
...
for rat_name in rats:
    data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data3\\'
    (Corr) = joblib.load(data_dir + rat_name + '_Y_PL5ex_coactivity_all_nrem_hfo.joblib')
...
ax2.text(0.5,L_mean*1.01 , "*",fontsize=15)
ax2.annotate('', xy=(0.2,L_mean*1.04), xytext=(1.8,L_mean*1.04), arrowprops=props)
ax2.text(0.9,L_mean*1.04 , "***",fontsize=15)
...
data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data5\\'
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_3_g_PL5ex_2.joblib'), compress=3)
...
for rat_name in rats:
    data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data3\\'
    (Corr) = joblib.load(data_dir + rat_name + '_Y_BLAex_coactivity_all_nrem_hfo.joblib')
...
data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data5\\'
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_3_g_BLAex_2.joblib'), compress=3)
...
fig.suptitle('co-activity Zscore in hfo during nrem', fontsize=20)
