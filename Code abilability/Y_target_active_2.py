...
def plot_nrem_fr(rat_name):
    ...
    (N_fr, R_fr) = joblib.load(data_dir + rat_name + '_Y_PL5inh_n_r_1_50_2.joblib')
    ...
    data_dir=r'C:\Users\saton\OneDrive\デスクトップ\\data3\\'
    joblib.dump((N,R), os.path.expanduser(data_dir+rat_name+'_Y_PL5inh_active_2_50_2.joblib'), compress=3)
    return fig
