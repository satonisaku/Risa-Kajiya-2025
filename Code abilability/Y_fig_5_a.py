...
for rat_name in rats:
    ...
    (Corr) = joblib.load(data_dir + rat_name + '_Y_vCA1ex_PL5ex_coactivity_all_nrem_swr.joblib')
    C=np.append(C,Corr)
...
#NN RR
ax1.annotate('', xy=(0.05,F_mean*1.04), xytext=(0.9,F_mean*1.04), arrowprops=props)
ax1.text(0.4,F_mean*1.04 , "***",fontsize=15)
#NN NR
ax1.annotate('', xy=(0.05,F_mean*1.06), xytext=(1.9,F_mean*1.06), arrowprops=props)
ax1.text(0.9,F_mean*1.06 , "***",fontsize=15)
#NN RN
ax1.annotate('', xy=(0.05,F_mean*1.1), xytext=(2.9,F_mean*1.1), arrowprops=props)
ax1.text(1.4,F_mean*1.1 , "**",fontsize=15)

data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data5\\'
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_5_a_vCA1ex_PL5ex.joblib'), compress=3)
...
for rat_name in rats:
    data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data3\\'
    #(Corr, _) = joblib.load(data_dir + rat_name + '_vCA1ex_BLAex_N_N_SWR_corr.joblib')
    (Corr) = joblib.load(data_dir + rat_name + '_Y_vCA1ex_BLAex_coactivity_all_nrem_swr.joblib')
    C=np.append(C,Corr)
...
#NN NR
ax2.annotate('', xy=(0.05,F_mean*1.06), xytext=(1.9,F_mean*1.06), arrowprops=props)
ax2.text(0.9,F_mean*1.06 , "***",fontsize=15)
#NN RN
ax2.annotate('', xy=(0.05,F_mean*1.1), xytext=(2.9,F_mean*1.1), arrowprops=props)
ax2.text(1.4,F_mean*1.1 , "**",fontsize=15)
#RR NR
ax2.annotate('', xy=(1.05,L_mean*1.06), xytext=(1.9,L_mean*1.06), arrowprops=props)
ax2.text(1.4,L_mean*1.06 , "***",fontsize=15)
#RR RN
ax2.annotate('', xy=(1.05,L_mean*1.4), xytext=(2.9,L_mean*1.4), arrowprops=props)
ax2.text(1.9,L_mean*1.4 , "***",fontsize=15)
...
data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data5\\'
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_5_a_vCA1ex_BLAex.joblib'), compress=3)
...
for rat_name in rats:
    data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data3\\'
    #(Corr, _) = joblib.load(data_dir + rat_name + '_vCA1ex_BLAex_N_N_SWR_corr.joblib')
    (Corr) = joblib.load(data_dir + rat_name + '_Y_PL5ex_BLAex_coactivity_all_nrem_swr.joblib')
    C=np.append(C,Corr)
...
#NN NR
#NN NR
ax3.annotate('', xy=(0.05,F_mean*1.07), xytext=(1.9,F_mean*1.07), arrowprops=props)
ax3.text(0.9,F_mean*1.07 , "***",fontsize=15)
#NN RN
ax3.annotate('', xy=(0.05,F_mean*1.1), xytext=(2.9,F_mean*1.1), arrowprops=props)
ax3.text(1.4,F_mean*1.1 , "***",fontsize=15)
#RR NR
ax3.annotate('', xy=(1.05,L_mean*1.06), xytext=(1.9,L_mean*1.06), arrowprops=props)
ax3.text(1.4,L_mean*1.06 , "***",fontsize=15)
#RR RN
ax3.annotate('', xy=(1.05,L_mean*1.4), xytext=(2.9,L_mean*1.4), arrowprops=props)
ax3.text(1.9,L_mean*1.4 , "*",fontsize=15)
...
data_dir = r'C:\Users\saton\OneDrive\デスクトップ\\data5\\'
joblib.dump((means,sem), os.path.expanduser(data_dir +'Y_fig_5_a_PL5ex_BLAex.joblib'), compress=3)
...
np.savetxt(r'C:\Users\saton\Dropbox\python\fig5_a_NN.csv', C1, delimiter=",")
print(np.loadtxt(r'C:\Users\saton\Dropbox\python\fig5_a_NN.csv', delimiter=','))
np.savetxt(r'C:\Users\saton\Dropbox\python\fig5_a_RR.csv', C2, delimiter=",")
np.savetxt(r'C:\Users\saton\Dropbox\python\fig5_a_NR.csv', C3, delimiter=",")
np.savetxt(r'C:\Users\saton\Dropbox\python\fig5_a_RN.csv', C4, delimiter=",")